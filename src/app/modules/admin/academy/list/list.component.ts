...
import { AcademyService } from 'app/modules/admin/academy/academy.service.service';
...
export class AcademyListComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _academyServiceService: AcademyService,
    )
    {
    }
    ...
    {
        // Get the categories
        this._academyServiceService.categories$
        ...
        // Get the courses
        this._academyServiceService.courses$
            .pipe(takeUntil(this._unsubscribeAll))
